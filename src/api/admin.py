...
def reset():
    ...
    with db.engine.begin() as connection:
        ...
        result = connection.execute(sqlalchemy.text("INSERT INTO transactions (description) VALUES ('Reset') RETURNING id"))
        ...
        connection.execute(sqlalchemy.text("INSERT INTO catalog_ledger (transaction_id, catalog_id, delta) VALUES (:transaction_id, Null, 0)"), [{"transaction_id": t_id}])
